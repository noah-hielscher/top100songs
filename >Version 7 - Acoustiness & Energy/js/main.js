...
$(function () {
	...
	renderer.append(
		"<div><h1>Um zu untersuchen, ob akustische Songs im Vergleich zu nicht-akustischen Songs eine andere Energie aufweisen.</h1></div>"
	);
...
function drawMap() {
	...
	songs.forEach((song) => {
		...
		const x = gmynd.map(song.acousticness, 0, 1, 0, stageWidth);
